...
class TestUtilities(unittest.TestCase):
    ...
    def test_convert_index_to_coordinates(self) -> None:
        ...
        exp_coords = [(0, 0), (0, 1), (0, 2), (0, 3), (1, 0), (1, 1), (1, 2), (1, 3), (2, 0), (2, 1), (2, 2), (2, 3)]
        self.assertEqual(coords, exp_coords)

    def test_convert_coordinates_to_index(self) -> None:
        n_rows = 3
        n_cols = 4
        coords = [(0, 0), (0, 1), (0, 2), (0, 3), (1, 0), (1, 1), (1, 2), (1, 3), (2, 0), (2, 1), (2, 2), (2, 3)]
    ...
    def test_proximity_iterator(self) -> None:
        ...
        grid = GridImpl(3, 4, ['a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'i', 'j', 'k', 'l'])
